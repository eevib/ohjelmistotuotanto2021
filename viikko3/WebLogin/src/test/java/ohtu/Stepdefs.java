...
public class Stepdefs {
    ...
    public void usernamePasswordAndMatchingPasswordConfirmationAreEntered (String username, String password){
    ...
    public void userIsNotCreatedWithTooShortUsername(String errormessage) {
        pageHasContent(errormessage);
    }
    @When("a valid username {string} and too short password {string} are entered")
    public void userIsNotCreatedWithTooShortPassword(String username, String password) {
        createNewAccount(username, password);
    }
    @When("a valid username {string}, password {string} and wrong password confirmation {string} are entered")
    public void userIsNotCreatedWithMismatchingPasswordAndPasswordConfirmation(String username, String password, String passwordConfirmation) {
