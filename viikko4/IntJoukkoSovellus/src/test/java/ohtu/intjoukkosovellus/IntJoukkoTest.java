...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.onTaulukossa(10));
        assertFalse(joukko.onTaulukossa(5));
        assertFalse(joukko.onTaulukossa(0));
        assertTrue(joukko.onTaulukossa(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.onTaulukossa(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.onTaulukossa(11));
        joukko.poista(11);
        assertFalse(joukko.onTaulukossa(11));
